...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Riddha.CourierMS.Android.dll" comes first in this list. */
		"Riddha.CourierMS.Android.dll",
		"Riddha.CourierMS.Common.Model.dll",
		"Riddha.CourierMS.Common.Services.dll",
		"Riddha.CourierMS.Model.dll",
		"Riddha.CourierMS.Services.dll",
		"Riddha.CourierMS.DB.dll",
