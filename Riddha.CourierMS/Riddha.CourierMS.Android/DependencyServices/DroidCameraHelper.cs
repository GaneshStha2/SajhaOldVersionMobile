...
[assembly: Dependency(typeof(DroidCameraHelper))]
namespace Riddha.CourierMS.Droid.DependencyServices
{
    public class DroidCameraHelper : ICameraHelper
    {
        ...
        public void LaunchCamera(FileFormatEnum fileType, string imageId)
        {
            ...
            if (takePictureIntent.ResolveActivity(MainActivity.ActivityContext.PackageManager) != null)
            {
                ...
                Android.Net.Uri photoURI = FileProvider.GetUriForFile(((Activity)MainActivity.ActivityContext), "com.riddha.courierms.fileprovider", cameraFile);
